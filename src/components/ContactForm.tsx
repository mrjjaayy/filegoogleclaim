    ...
    <div id="contact-form" className="form-section">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-xs text-gray-600 leading-relaxed">
              <p className="mb-3">
                <strong>The estimated potential recovery tool estimates the maximum possible recovery based on the ad spend you submit. The case may settle for a significantly lower percentage.</strong> We may follow up with you by phone and text pursuant to our <a href="https://www.kpinjury.com/google-claim-estimate/clkn/https/www.kpinjury.com/termsandconditions/" className="text-kp-blue underline">terms and conditions</a>. By signing up, you agree to our <a href="https://www.kpinjury.com/google-claim-estimate/clkn/https/www.kpinjury.com/termsandconditions/" className="text-kp-blue underline">terms and conditions</a> and <a href="https://www.kpinjury.com/google-claim-estimate/clkn/https/www.kellerpostman.com/privacy-policy/" className="text-kp-blue underline">privacy policy</a>.
              </p>
              <p>
